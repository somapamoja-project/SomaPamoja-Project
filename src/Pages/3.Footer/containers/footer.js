...
export default function FooterContainer({ emailName,logeOut }) {
  const navigation5 = useNavigate();
      ...
      <Footer.Wrapper>
        <Footer.Row>
          <Footer.Column>
            ...
            <Link className="imgLogo" to="/about">
              <img src={OfficalLogo} alt="loading" />
            </Link>
          </Footer.Column>
          <Footer.Column>
          ...
          <Footer.Column>
            ...
            <button className="btn btn-dark" onClick={logeOut}>
              {" "}
              LogOut
            </button>
          </Footer.Column>
