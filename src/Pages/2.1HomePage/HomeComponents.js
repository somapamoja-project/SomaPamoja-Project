...
import GamingSpaceImage from "../../Images/GamingSpace.JPG";
...
export function Expo() {
  return (
    <div className="Container">
      <div className="Expo">
        <a
          href="https://play.google.com/store/search?q=expo&c=apps"
          style={{ marginLeft: "35%", fontSize: "30px" }}
          target="_blank"
        >
          Download Expo on PlayStore here
        </a>
...
export function GamingSpace() {
  return (
    <div className="container" id="GamingSpace">
      <div className="GamingSpace">
        <div>
          <h1>Gaming Space </h1>
          <p>
            After learning , Students need to relax, that why we create Game
            Space
          </p>
        </div>
        <img src={GamingSpaceImage} alt="loading..." />
      </div>
      <Link to="/Gaming-Space" className="btn btn-primary" id="StartGaming1">
        Start Gaming{" "}
      </Link>
    </div>
  );
